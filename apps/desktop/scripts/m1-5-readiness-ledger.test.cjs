...
test("M1.5 readiness ledger keeps phase status conservative", () => {
  ...
  assert.equal(ledger.slice, "W1.5.234");
...
test("M1.5 readiness ledger records roadmap item gaps without claiming exit readiness", () => {
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /routed blocker packages as needs_followup_not_accepted/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /W1\.5\.227/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /planned_not_implemented follow-up items/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /W1\.5\.228/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /reviewer-owned handoff packages/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /W1\.5\.229/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /handoff packages .*needs_followup_not_accepted/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /W1\.5\.230/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /handoff package follow-up items .* planned_not_implemented/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /W1\.5\.231/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /reviewer-owned handoff follow-up packages/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /W1\.5\.232/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /reviewer decisions .*needs_followup_not_accepted/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /W1\.5\.233/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.verified_evidence.join(" ") ?? "",
    /reviewer-owned handoff follow-up needs-followup packages/u,
  );
  assert.match(
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /runtime UX packaged follow-up reviewer decisions .* needs_followup_not_accepted/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /FR-012 A8 packaged follow-up reviewer decision as needs_followup_not_accepted/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /6 runtime_harness\.md §8\.2 rows are still explicitly deferred/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /3 route package decisions/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /11 routed blocker decisions/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /3 route package follow-up items/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /11 routed blocker follow-up items/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /3 handoff packages/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /11 handoff items/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /handoff_prepared_not_accepted/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /W1\.5\.232/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /handoff follow-up package decisions .*needs_followup_not_accepted/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /W1\.5\.233/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /handoff follow-up package follow-up items .*planned_not_implemented/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /3 handoff package decisions/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /11 routed blocker handoff decisions/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /needs_followup_not_accepted/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /3 handoff package follow-up items/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /11 routed blocker handoff follow-up items/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /planned_not_implemented/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /W1\.5\.234/u,
  ...
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /handoff follow-up needs-followup packages .*handoff_prepared_not_accepted/u,
  );
  assert.match(
    roadmapItemsById.get("M1.5-R7")?.remaining_gap.join(" ") ?? "",
    /W1\.5\.231/u,
