...
| 关联 spec | 全部已锁定 schema spec（被引用为落盘对象）+ `state_machines/planning_session.md` + `protocols/agent_adapter.md` |
| 关联 ADR | ADR-0007（持久化分层）、ADR-0008（StreamEvent）、ADR-0006（Electron）、ADR-0011（Claude 个人记忆 vs 项目记忆边界） |
